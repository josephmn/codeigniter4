...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="<?= base_url() ?>dist/img/netprodex_logo1.png" alt="AdminLTELogo" height="60" width="60">
        </div>
        ...
        <aside class="main-sidebar sidebar-dark-warning elevation-4">
            ...
            <a href="<?=base_url();?>" class="brand-link">
                <img src="<?= base_url() ?>dist/img/netprodex_logo2.png" alt="logo" class="brand-image img-circle elevation-3"
                    style="opacity: .8">
